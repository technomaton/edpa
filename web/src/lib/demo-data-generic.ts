...
export const items: WorkItem[] = [
  ...
  { id: 'S-100', title: 'JWT auth implementation', level: 'Story', js: 8, bv: 8, tc: 5, rr: 3, parentId: 'F-10', status: 'Done', iteration: 'PI-2026-1.1', contributors: [
    { personId: 'bob', cw: 1, rs: 1 }, { personId: 'alice', cw: 0.30, rs: 0.8 }
  ]},
  { id: 'S-101', title: 'OAuth2 integration', level: 'Story', js: 5, bv: 5, tc: 3, rr: 2, parentId: 'F-10', status: 'Done', iteration: 'PI-2026-1.1', contributors: [
    { personId: 'bob', cw: 1, rs: 1 }, { personId: 'dave', cw: 0.6, rs: 1 }
  ]},
  { id: 'S-102', title: 'Auth unit tests', level: 'Story', js: 3, bv: 3, tc: 2, rr: 1, parentId: 'F-10', status: 'Done', iteration: 'PI-2026-1.1', contributors: [
    { personId: 'alice', cw: 1, rs: 1 }
  ]},
  { id: 'S-103', title: 'Profile CRUD endpoints', level: 'Story', js: 5, bv: 5, tc: 5, rr: 2, parentId: 'F-11', status: 'Done', iteration: 'PI-2026-1.1', contributors: [
    { personId: 'carol', cw: 1, rs: 1 }, { personId: 'frank', cw: 0.6, rs: 0.8 }
  ]},
  { id: 'S-104', title: 'Profile validation', level: 'Story', js: 3, bv: 3, tc: 3, rr: 1, parentId: 'F-11', status: 'Done', iteration: 'PI-2026-1.1', contributors: [
    { personId: 'frank', cw: 1, rs: 1 }, { personId: 'carol', cw: 0.25, rs: 0.6 }
  ]},

  // Stories PI-2026-1.2 (all Done)
  { id: 'S-105', title: 'Stripe integration', level: 'Story', js: 8, bv: 8, tc: 8, rr: 5, parentId: 'F-20', status: 'Done', iteration: 'PI-2026-1.2', contributors: [
    { personId: 'bob', cw: 1, rs: 1 }, { personId: 'frank', cw: 0.6, rs: 1 }, { personId: 'dave', cw: 0.15, rs: 0.5 }
  ]},
  { id: 'S-106', title: 'Payment webhook handler', level: 'Story', js: 5, bv: 5, tc: 5, rr: 3, parentId: 'F-20', status: 'Done', iteration: 'PI-2026-1.2', contributors: [
    { personId: 'frank', cw: 1, rs: 1 }, { personId: 'bob', cw: 0.25, rs: 0.6 }
  ]},
  { id: 'S-107', title: 'Subscription plan model', level: 'Story', js: 5, bv: 5, tc: 5, rr: 3, parentId: 'F-21', status: 'Done', iteration: 'PI-2026-1.2', contributors: [
    { personId: 'carol', cw: 1, rs: 1 }, { personId: 'alice', cw: 0.6, rs: 0.8 }
  ]},
  { id: 'S-108', title: 'Plan upgrade flow', level: 'Story', js: 3, bv: 3, tc: 3, rr: 2, parentId: 'F-21', status: 'Done', iteration: 'PI-2026-1.2', contributors: [
    { personId: 'carol', cw: 1, rs: 1 }, { personId: 'eve', cw: 0.20, rs: 0.5 }
  ]},
  { id: 'S-109', title: 'CI/CD pipeline setup', level: 'Story', js: 5, bv: 5, tc: 5, rr: 3, parentId: 'F-10', status: 'Done', iteration: 'PI-2026-1.2', contributors: [
    { personId: 'dave', cw: 1, rs: 1 }, { personId: 'alice', cw: 0.30, rs: 0.6 }
  ]},

  // Stories PI-2026-1.3 (all Done)
  { id: 'S-110', title: 'Invoice generation', level: 'Story', js: 5, bv: 5, tc: 5, rr: 3, parentId: 'F-20', status: 'Done', iteration: 'PI-2026-1.3', contributors: [
    { personId: 'frank', cw: 1, rs: 1 }, { personId: 'bob', cw: 0.25, rs: 0.6 }
  ]},
  { id: 'S-111', title: 'Billing dashboard UI', level: 'Story', js: 5, bv: 5, tc: 3, rr: 2, parentId: 'F-20', status: 'Done', iteration: 'PI-2026-1.3', contributors: [
    { personId: 'carol', cw: 1, rs: 1 }, { personId: 'eve', cw: 0.6, rs: 0.8 }
  ]},
  { id: 'S-112', title: 'Usage metering', level: 'Story', js: 8, bv: 8, tc: 8, rr: 5, parentId: 'F-21', status: 'Done', iteration: 'PI-2026-1.3', contributors: [
    { personId: 'bob', cw: 1, rs: 1 }, { personId: 'alice', cw: 0.6, rs: 1 }, { personId: 'dave', cw: 0.15, rs: 0.5 }
  ]},
  { id: 'S-113', title: 'Rate limiting', level: 'Story', js: 3, bv: 3, tc: 3, rr: 5, parentId: 'F-11', status: 'Done', iteration: 'PI-2026-1.3', contributors: [
    { personId: 'dave', cw: 1, rs: 1 }, { personId: 'alice', cw: 0.30, rs: 0.6 }
  ]},
  { id: 'S-114', title: 'E2E test suite', level: 'Story', js: 3, bv: 3, tc: 2, rr: 2, parentId: 'F-10', status: 'Done', iteration: 'PI-2026-1.3', contributors: [
    { personId: 'alice', cw: 1, rs: 1 }, { personId: 'bob', cw: 0.25, rs: 0.6 }
  ]},

  // Stories PI-2026-1.4 (active iteration — mix Done + In Progress)
  { id: 'S-115', title: 'API documentation', level: 'Story', js: 2, bv: 2, tc: 1, rr: 1, parentId: 'F-10', status: 'Done', iteration: 'PI-2026-1.4', contributors: [
    { personId: 'alice', cw: 1, rs: 1 }, { personId: 'eve', cw: 0.20, rs: 0.5 }
  ]},
  { id: 'S-116', title: 'Architecture review', level: 'Story', js: 3, bv: 3, tc: 2, rr: 3, parentId: 'F-11', status: 'Done', iteration: 'PI-2026-1.4', contributors: [
