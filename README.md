...
[![EDPA](https://img.shields.io/badge/EDPA-1.23.1-34d399)](docs/methodology.md)
...
EDPA 1.23.1 — Iteration PI-2026-1.3
======================================================================
...
EDPA Installer
  ...
  openpyxl ✓
  ...
EDPA 1.23.1 installed successfully!
```
...
```
======================================================================
EDPA 1.23.1 — Iteration PI-2026-1.1
======================================================================
Person                    Role     Capacity  Derived  Items   OK
----------------------------------------------------------------------
...
|----------|-------------|
| [Methodology](docs/methodology.md) | Full EDPA v1.23.1 specification |
