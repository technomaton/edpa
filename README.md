...
[![EDPA](https://img.shields.io/badge/EDPA-1.8.1--beta-34d399)](docs/methodology.md)
...
EDPA 1.8.1-beta — Iteration PI-2026-1.3 (gates mode)
======================================================================
...
EDPA Installer
  ...
  openpyxl ✓
  ...
EDPA 1.8.1-beta installed successfully!
```
...
|----------|-------------|
| [Methodology](docs/methodology.md) | Full EDPA v1.8.1-beta specification |
