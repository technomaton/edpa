...
[![EDPA](https://img.shields.io/badge/EDPA-1.19.3-34d399)](docs/methodology.md)
...
EDPA 1.19.3 — Iteration PI-2026-1.3
======================================================================
...
EDPA Installer
  ...
  openpyxl ✓
  ...
EDPA 1.19.3 installed successfully!
```
...
```
======================================================================
EDPA 1.19.3 — Iteration PI-2026-1.1
======================================================================
Person                    Role     Capacity  Derived  Items   OK
----------------------------------------------------------------------
...
|----------|-------------|
| [Methodology](docs/methodology.md) | Full EDPA v1.19.3 specification |
