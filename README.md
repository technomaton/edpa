...
[![EDPA](https://img.shields.io/badge/EDPA-1.13.0--beta-34d399)](docs/methodology.md)
...
EDPA 1.13.0-beta — Iteration PI-2026-1.3 (gates mode)
======================================================================
...
EDPA Installer
  ...
  openpyxl ✓
  ...
EDPA 1.13.0-beta installed successfully!
```
...
```
======================================================================
EDPA 1.13.0-beta — Iteration PI-2026-1.1 (gates mode)
======================================================================
Person                    Role     Capacity  Derived  Items   OK
----------------------------------------------------------------------
