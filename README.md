...
[![EDPA](https://img.shields.io/badge/EDPA-2.11.1-34d399)](docs/methodology.md)
...
EDPA 2.11.1 — Iteration PI-2026-1.3
======================================================================
...
EDPA Installer
  ...
  openpyxl ✓
  ...
EDPA 2.11.1 installed successfully!
```
...
```
======================================================================
EDPA 2.11.1 — Iteration PI-2026-1.1
======================================================================
Person                    Role     Capacity  Derived  Items   OK
----------------------------------------------------------------------
...
|----------|-------------|
| [Methodology](docs/methodology.md) | Full EDPA v2.11.1 specification |
