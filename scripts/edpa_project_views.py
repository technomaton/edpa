...
Usage:
    ...
    python scripts/edpa_project_views.py template --org technomaton --project 4

    # Generate setup instructions for a project
    python scripts/edpa_project_views.py instructions --org technomaton --project 4

    # Create a new project from template
    python scripts/edpa_project_views.py create-from-template --org technomaton --template 4 --title "New Project"

    # Verify views are configured correctly
    python scripts/edpa_project_views.py verify --org technomaton --project 4
"""
...
def cmd_template(args):
    ...
    if data and "data" in data:
        ...
        print(f"    python scripts/edpa_project_views.py create-from-template \\")
...
def cmd_create_from_template(args):
    ...
    if data and "data" in data:
        ...
        print(f"  Next: populate with issues using edpa_project_setup.py{C.RESET}")
    else:
...
def cmd_verify(args):
    ...
    if passed < total:
        ...
        print(f"    python scripts/edpa_project_views.py instructions --org {args.org} --project {args.project}")
...
def cmd_instructions(args):
    ...
    print(f"    python scripts/edpa_project_views.py template --org {args.org} --project {args.project}")
    print(f"\n  Ověř konfiguraci:")
    print(f"    python scripts/edpa_project_views.py verify --org {args.org} --project {args.project}")
    print()
